...
namespace MgsvModBldr.Tools.Spch
{
    public class FnvHash
    {
        ...
        public virtual void Read(BinaryReader reader, System.Collections.Generic.Dictionary<uint, string> hashLookupTable, HashIdentifiedDelegate hashIdentifiedCallback)
        {
